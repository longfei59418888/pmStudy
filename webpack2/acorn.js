(function (global, factory) {
    ...
    var types = {
        ...
        eof: new TokenType("eof"),  // end of file 定界符
    ...
    var Parser = function Parser(options, input, startPos) {
        ...
        // 获取上下文，表达式 '{} ()  function' , 是上下文的表达式
        this.context = this.initialContext();
        // 允许表达式
        this.exprAllowed = true;

        // 是否是模块模式，支持 import/export
    ...
    pp$2.parseBindingAtom = function () {
        if (this.options.ecmaVersion >= 6) {
            switch (this.type) {
                case types.bracketL:  // 数组
                    var node = this.startNode();
                    this.next();
                    node.elements = this.parseBindingList(types.bracketR, true, true);
                    return this.finishNode(node, "ArrayPattern")

                case types.braceL: // 对象
    ...
    pp$9.skipSpace = function () {  // 跳过空格换行以及注释
        loop: while (this.pos < this.input.length) {
            ...
            switch (ch) {
                ...
                case 160: // ' ' 空格
                    ++this.pos;
                    break
                case 13: // CR 转义字符\r，表示回车
                    if (this.input.charCodeAt(this.pos + 1) === 10) {  // 转义字符\n，表示换行
                        ++this.pos;  // \r\n 下一个
                    }
                case 10:
                case 8232:
